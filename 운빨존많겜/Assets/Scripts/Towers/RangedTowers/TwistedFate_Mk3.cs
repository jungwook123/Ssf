...
public class TwistedFate_Mk3 : TwistedFate_Mk2
{
    ...
    protected override Debuff bulletDebuff => new TwistedFate_Mk3_Fate(fateDuration, fateEffect, fateSound, bullet, pulseBulletDamage, pulseBulletSpeed, hitSound, pulseBulletCount, maxPulseHit, fateDamage);
}
